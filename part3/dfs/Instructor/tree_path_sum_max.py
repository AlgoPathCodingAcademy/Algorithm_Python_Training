...
# ------------------------------------------------------------
# reference solution (used to check the student’s getSumTree)
# ------------------------------------------------------------
def max_root_leaf(node):
    ...
    left_tree_sum = max_root_leaf(node.left)
    right_tree_sum = max_root_leaf(node.right)
    
    max_sub_tree = max(left_tree_sum,right_tree_sum)
    
    return node.value + max_sub_tree
