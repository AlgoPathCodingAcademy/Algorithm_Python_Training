...
def dijkstra_shortest_path(n, adjacency_list, source, destination):
    ...
    visited = [False] * n  # to track which nodes have been "finalized"
    ...
    while pq:
        ...
        # Early stop: once we pop 'destination', its distance is final
        if u == destination:
            return dist_u  # dist_u is the shortest distance to 'destination'
